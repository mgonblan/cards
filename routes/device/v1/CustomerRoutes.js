...
const CustomerController = require('../../../controller/device/v1/Customer');
const {
...
router.route('/device/api/v1/customer/:id').get(auth(PLATFORM.DEVICE),checkRolePermission,CustomerController.getCustomerById);
