...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'QtYpYmlrR1sTGfb',
      'isDeleted':false,
      'username':'Conor97',
      'email':'Coy.Beer19@yahoo.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let user = await userDb.updateOne( { 'username':'Conor97' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
    userToBeInserted = {
      'password':'N4m46My3dJQw0CZ',
      'isDeleted':false,
      'username':'Marta_Stehr',
      'email':'Kimberly19@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let admin = await userDb.updateOne( { 'username':'Marta_Stehr' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
...
async function seedRouteRole () {
  try {
    const routeRoles = [ 
      ...
      {
        route: '/admin/card/create',
        role: 'System_User',
        method: 'POST' 
      },
      {
        route: '/admin/card/addbulk',
        role: 'System_User',
        method: 'POST' 
      },
      {
        route: '/admin/card/list',
        role: 'System_User',
        method: 'POST' 
      },
      {
      ...
      {
        route: '/admin/card/count',
        role: 'System_User',
        method: 'POST' 
      },
      {
        route: '/admin/card/update/:id',
        role: 'System_User',
        method: 'PUT' 
      },
      {
        route: '/admin/card/partial-update/:id',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/admin/card/updatebulk',
        role: 'System_User',
        method: 'PUT' 
      },
      {
        route: '/admin/card/softdelete/:id',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/admin/card/softdeletemany',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/admin/card/delete/:id',
        role: 'System_User',
        method: 'DELETE'
      },
      {
        route: '/admin/card/deletemany',
        role: 'System_User',
        method: 'POST'
      },
      {
      ...
      {
        route: '/device/api/v1/card/create',
        role: 'System_User',
        method: 'POST'
      },
      {
        route: '/device/api/v1/card/addbulk',
        role: 'System_User',
        method: 'POST'
      },
      {
        route: '/device/api/v1/card/list',
        role: 'System_User',
        method: 'POST'
      },
      {
        route: '/device/api/v1/card/:id',
        role: 'System_User',
        method: 'GET'
      },
      {
        route: '/device/api/v1/card/count',
        role: 'System_User',
        method: 'POST'
      },
      {
        route: '/device/api/v1/card/update/:id',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/device/api/v1/card/partial-update/:id',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/device/api/v1/card/updatebulk',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/device/api/v1/card/softdelete/:id',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/device/api/v1/card/softdeletemany',
        role: 'System_User',
        method: 'PUT'
      },
      {
        route: '/device/api/v1/card/delete/:id',
        role: 'System_User',
        method: 'DELETE'
      },
      {
        route: '/device/api/v1/card/deletemany',
        role: 'System_User',
        method: 'POST'
      },
      {
